...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'NodePlan') }}</title>
    ...
    <body class="font-gummy text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-fondo">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md shadow-verdes-dark overflow-hidden sm:rounded-lg">
                {{ $slot }}
            </div>
        </div>
    </body>
